...
public class Manager {
    ...
    public Manager(String id, int status, String username, String password, String phone, String email, String name, Image photo, String role, String lastLoginIP, String lastLoginCity, long lastLoginTime, long updateTime, long createTime) {
        this.id = id;
        this.status = status;
